  ...
  return (
    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto '>
        ...
        >
          <img src={logo} alt="logo" className='w-10 h-10 rounded-full object-contain'></img>
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Shreya &nbsp;<span className='sm:block hidden'>Joshi</span></p>
        </Link>
        <ul
